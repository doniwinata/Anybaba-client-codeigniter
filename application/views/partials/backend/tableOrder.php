...
<div class="container">
  ...
  <div class="col-xs-6">
    <div class="btn-toolbar">
      <div class="btn-group">
        <a class="btn btn-primary" href="<?php echo site_url().'/orders/manage/ordering' ?>"><span class="fui-time"></span> Pending Order</a>
        <a class="btn btn-success" href="<?php echo site_url().'/orders/manage/paid' ?>"><span class="fui-check"></span> Paid Order</a>
         <a class="btn btn-danger" href="<?php echo site_url().'/orders/manage/finished' ?>"><span class="fui-star"></span> Finished Order</a>
